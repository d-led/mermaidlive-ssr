  ...
  def render(assigns) do
    ...
    <div class="pre-rendered-state-machine">
      <svg
        ...
        viewBox="0 0 253.8984375 412"
        style="max-width: 253.898px; background-color: white;"
        class="statediagram"
        ...
        <g>
          <defs>
            <marker
              ...
              refY="7"
              refX="19"
              id="my-svg_stateDiagram-barbEnd"
            >
          ...
          <g class="root">
            ...
            <g class="edgePaths">
              <path
                marker-end="url(#my-svg_stateDiagram-barbEnd)"
                style="fill:none;"
                class="edge-thickness-normal edge-pattern-solid transition"
                id="edge0"
                d="M72.016,22L72.016,26.167C72.016,30.333,72.016,38.667,72.016,47C72.016,55.333,72.016,63.667,72.016,67.833L72.016,72"
              />
              <path
                marker-end="url(#my-svg_stateDiagram-barbEnd)"
                style="fill:none;"
                class="edge-thickness-normal edge-pattern-solid transition"
                id="edge1"
                d="M104.162,112L114.074,118.167C123.986,124.333,143.809,136.667,151.725,149C159.641,161.333,155.649,173.667,153.653,179.833L151.657,186"
              />
              <path
                marker-end="url(#my-svg_stateDiagram-barbEnd)"
                style="fill:none;"
                class="edge-thickness-normal edge-pattern-solid transition"
                id="edge2"
                d="M122.885,226L116.01,232.167C109.134,238.333,95.384,250.667,88.508,263C81.633,275.333,81.633,287.667,77.969,299.167C74.304,310.667,66.976,321.333,63.311,326.667L59.647,332"
              />
              <path
                marker-end="url(#my-svg_stateDiagram-barbEnd)"
                style="fill:none;"
                class="edge-thickness-normal edge-pattern-solid transition"
                id="edge3"
                d="M119.511,186L111.595,179.833C103.679,173.667,87.847,161.333,79.931,149C72.016,136.667,72.016,124.333,72.016,118.167L72.016,112"
              />
              <path
                marker-end="url(#my-svg_stateDiagram-barbEnd)"
                style="fill:none;"
                class="edge-thickness-normal edge-pattern-solid transition"
                id="edge4"
                d="M38.361,332L36.349,326.667C34.337,321.333,30.313,310.667,28.301,299.167C26.289,287.667,26.289,275.333,26.289,259.667C26.289,244,26.289,225,26.289,206C26.289,187,26.289,168,31.236,152.333C36.183,136.667,46.077,124.333,51.024,118.167L55.971,112"
              />
              <path
                style={
                  if @state == "working" and @counter > 0,
                    do: "fill:none;",
                    else: "fill:none;display:none;"
                }
                class="edge-thickness-normal edge-pattern-solid transition note-edge"
                id="working-working----note-5"
                d="M158.2,226L162.214,232.167C166.227,238.333,174.254,250.667,178.268,263C182.281,275.333,182.281,287.667,182.281,298C182.281,308.333,182.281,316.667,182.281,320.833L182.281,325"
              />
            </g>
            <g class="edgeLabels">
              <g class="edgeLabel">
              ...
              <g
                transform="translate(163.6328125, 149)"
                class="edgeLabel"
                phx-click="start"
                style={
                  if @state == "waiting",
                    do: "cursor: pointer;",
                    else: "cursor: default; opacity: 0.5;"
                }
                role="button"
                tabindex={if @state == "waiting", do: "0", else: "-1"}
                ...
                <g transform="translate(-16.8984375, -12)" class="label">
                  <foreignObject height="24" width="33.796875">
                    <div
                      ...
                      xmlns="http://www.w3.org/1999/xhtml"
                    >
                      <span class="edgeLabel" style="text-decoration: underline;">
                        <p>start</p>
                      </span>
                    </div>
                  </foreignObject>
              ...
              <g
                transform="translate(81.6328125, 263)"
                class="edgeLabel"
                phx-click="abort"
                style={
                  if @state == "working",
                ...
                role="button"
                tabindex={if @state == "working", do: "0", else: "-1"}
            ...
            <g class="nodes">
              ...
              <g
                transform="translate(72.015625, 92)"
                id="state-waiting-4"
                class={"node #{if @state == "waiting", do: "inProgress", else: ""} statediagram-state"}
              >
                <rect
                  height="40"
                  width="68.5625"
              ...
              <g
                transform="translate(145.18359375, 206)"
                id="state-working-5"
                class={"node #{if @state == "working", do: "inProgress", else: ""} statediagram-state"}
              >
                <rect
                  height="40"
                  width="72.90625"
              ...
              <g
                transform="translate(45.90625, 352)"
                id="state-aborting-4"
                class={"node #{if @state == "aborting", do: "inProgress", else: ""} statediagram-state"}
              >
                <rect
                  height="40"
                  width="75.8125"
              ...
              <g
                transform="translate(186.9921875, 352)"
                id="state-working----note-5"
                class="node statediagram-note"
                style={
                  if @state == "working" and @counter > 0, do: "display: block", else: "display: none"
                }
              >
                <g class="basic label-container">
                  <path
                    ...
                    stroke-width="0"
                    stroke="none"
                    d="M-23.90625 -27 L23.90625 -27 L23.90625 27 L-23.90625 27"
                  />
                  <path
                    style=""
                    fill="none"
                ...
                <g transform="translate(-8.90625, -12)" style="" class="label">
                  ...
                  <foreignObject height="24" width="17.8125">
                    <div
                      style="display: flex; align-items: center; justify-content: center; height: 100%; width: 100%; text-align: center;"
                      xmlns="http://www.w3.org/1999/xhtml"
                    >
                      <span class="nodeLabel">
                        <p style="margin: 0; padding: 0;">{@counter}</p>
                      </span>
                    </div>
                  </foreignObject>
                </g>
